    ...
    <>
      <div className="h-[60px] bg-white border-b border-border-school flex items-center justify-between px-6 flex-shrink-0 shadow-sm">
        <div>
          ...
          <div className="text-[11px] text-text-300 font-[family-name:var(--font-noto-devanagari)]">TC, बोनाफाईड, U-DISE अहवाल</div>
        </div>
      </div>
      <div className="flex-1 overflow-y-auto p-6 bg-[#F4F7FB]">
        <div className="bg-white rounded-2xl border border-border-school p-16 text-center shadow-sm">
          ...
          <p className="text-text-500 font-[family-name:var(--font-noto-devanagari)] text-sm max-w-sm mx-auto">TC, बोनाफाईड, जन्म दाखला आणि U-DISE एक्सपोर्ट येथे मिळेल.</p>
        </div>
      </div>
    </>
  )
