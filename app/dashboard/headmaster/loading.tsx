export default function HeadmasterLoading() {
  return (
    <>
      <div className="h-[60px] bg-white border-b border-border-school flex items-center justify-between px-6 md:px-7 flex-shrink-0">
        <div className="h-5 w-48 bg-cream-2 rounded animate-pulse" />
        <div className="h-4 w-32 bg-cream-2 rounded animate-pulse" />
      </div>
